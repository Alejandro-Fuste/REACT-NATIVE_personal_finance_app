...
# Last name missing
def test_create_user_last_name_missing(create_new_user_last_name_blank):
    try:
        user_service.create_new_user(create_new_user_last_name_blank)
        assert False
    except InputMissing as e:
        assert str(e) == input_not_provided
...
# Last name too short
def test_create_user_last_name_too_short(create_new_user_last_name_too_short):
    try:
        user_service.create_new_user(create_new_user_last_name_too_short)
        assert False
    except InputTooShort as e:
        assert str(e) == input_too_short
...
# Email wrong format
def test_create_user_email_wrong_format(create_new_user_email_wrong_format):
    try:
        user_service.create_new_user(create_new_user_email_wrong_format)
        assert False
...
# username not string
def test_create_user_username_not_string(create_new_user_username_number):
    try:
...
# username missing
def test_create_user_username_missing(create_new_user_username_name_blank):
    try:
        user_service.create_new_user(create_new_user_username_name_blank)
        assert False
    except InputMissing as e:
        assert str(e) == input_not_provided
...
# username too long
def test_create_user_username_too_long(create_new_user_username_too_long):
    try:
        user_service.create_new_user(create_new_user_username_too_long)
        assert False
    except InputTooLong as e:
        assert str(e) == input_too_long
...
# Password not string
def test_create_user_password_not_string(create_new_user_password_number):
    try:
        user_service.create_new_user(create_new_user_password_number)
        assert False
    except InputNotString as e:
        assert str(e) == input_must_be_string
